...
def main(argv=None):
    parser = argparse.ArgumentParser(
        prog="openpronounce",
        description="Score the pronunciation of an English recording against the sentence it should contain.",
    )
    ...
    result = speech.compare_audio_with_text(sound, args.text)
